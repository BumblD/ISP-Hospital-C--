...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2019 at 10:01 PM
...
CREATE TABLE `grafikai` (
  `id` int(11) NOT NULL,
  `data` date NOT NULL,
  `pradzia_val` int(11) NOT NULL,
  `pabaiga_val` int(11) NOT NULL,
...
INSERT INTO `grafikai` (`id`, `data`, `pradzia_val`, `pabaiga_val`, `fk_GYDYTOJASid`) VALUES
(1, '2020-01-06', 8, 12, 3),
(2, '2020-01-07', 12, 16, 3),
(3, '2020-01-08', 8, 12, 3),
(4, '2020-01-09', 12, 16, 3),
(5, '2020-01-10', 8, 12, 3),
(6, '2020-01-06', 12, 16, 4),
(7, '2020-01-07', 8, 12, 4),
(8, '2020-01-08', 12, 16, 4),
(9, '2020-01-09', 8, 12, 4),
(10, '2020-01-10', 12, 16, 4);
...
INSERT INTO `pacientai` (`id`, `ugis`, `mase`, `kraujo_grupe`, `rezus`, `fk_GYDYTOJASid`, `fk_ASMENINE_INFOasmens_kodas`) VALUES
(1, NULL, NULL, NULL, NULL, 3, '31111111111'),
(2, NULL, NULL, NULL, NULL, 3, '31211111111'),
(3, NULL, NULL, NULL, NULL, 4, '31311111111');
...
INSERT INTO `proceduros_tipas` (`id`, `name`) VALUES
(1, 'masazas'),
(2, 'sildymas');
...
ALTER TABLE `grafikai`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_GYDYTOJASid` (`fk_GYDYTOJASid`);
...
--
ALTER TABLE `patalpos`
  MODIFY `nr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `grafikai`
  ADD CONSTRAINT `grafikai_ibfk_1` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`);

--
-- Constraints for table `gydytojai`
--
ALTER TABLE `gydytojai`
  ADD CONSTRAINT `gydytojai_ibfk_1` FOREIGN KEY (`specializacija`) REFERENCES `gydytojo_tipas` (`id`),
  ADD CONSTRAINT `yra` FOREIGN KEY (`fk_PERSONALO_DARBUOTOJAStabelio_numeris`) REFERENCES `personalo_darbuotojai` (`tabelio_numeris`);

--
-- Constraints for table `israsytos_proceduros`
--
ALTER TABLE `israsytos_proceduros`
  ADD CONSTRAINT `atlieka_p` FOREIGN KEY (`fk_PATALPAnr`) REFERENCES `patalpos` (`nr`),
  ADD CONSTRAINT `israsytos_proceduros_ibfk_1` FOREIGN KEY (`procedura`) REFERENCES `proceduros_tipas` (`id`),
  ADD CONSTRAINT `naudoja_p` FOREIGN KEY (`fk_PACIENTASid`) REFERENCES `pacientai` (`id`),
  ADD CONSTRAINT `skiria_p` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`);

--
-- Constraints for table `pacientai`
--
ALTER TABLE `pacientai`
  ADD CONSTRAINT `apibudina_p` FOREIGN KEY (`fk_ASMENINE_INFOasmens_kodas`) REFERENCES `asmenine_info` (`asmens_kodas`),
  ADD CONSTRAINT `pacientai_ibfk_1` FOREIGN KEY (`kraujo_grupe`) REFERENCES `kraujo_grupe` (`id`),
  ADD CONSTRAINT `rupinasi` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`);

--
-- Constraints for table `patalpos`
--
ALTER TABLE `patalpos`
  ADD CONSTRAINT `patalpos_ibfk_1` FOREIGN KEY (`tipas`) REFERENCES `patalpos_tipas` (`id`);

--
-- Constraints for table `personalo_darbuotojai`
--
ALTER TABLE `personalo_darbuotojai`
  ADD CONSTRAINT `apibudina_pd` FOREIGN KEY (`fk_ASMENINE_INFOasmens_kodas`) REFERENCES `asmenine_info` (`asmens_kodas`),
  ADD CONSTRAINT `skiriama_d` FOREIGN KEY (`fk_PATALPAnr`) REFERENCES `patalpos` (`nr`);

--
-- Constraints for table `receptai`
--
ALTER TABLE `receptai`
  ADD CONSTRAINT `israso_r` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`),
  ADD CONSTRAINT `naudoja_r` FOREIGN KEY (`fk_PACIENTASid`) REFERENCES `pacientai` (`id`),
  ADD CONSTRAINT `parduodamas_pagal` FOREIGN KEY (`fk_VAISTASid`) REFERENCES `vaistai` (`id`);

--
-- Constraints for table `siuntimai`
--
ALTER TABLE `siuntimai`
  ADD CONSTRAINT `israso_s` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`),
  ADD CONSTRAINT `naudoja_s` FOREIGN KEY (`fk_PACIENTASid`) REFERENCES `pacientai` (`id`),
  ADD CONSTRAINT `siuntimai_ibfk_1` FOREIGN KEY (`specialistas`) REFERENCES `gydytojo_tipas` (`id`);

--
-- Constraints for table `tyrimai`
--
ALTER TABLE `tyrimai`
  ADD CONSTRAINT `atlieka_t` FOREIGN KEY (`fk_PATALPAnr`) REFERENCES `patalpos` (`nr`),
  ADD CONSTRAINT `naudoja_t` FOREIGN KEY (`fk_PACIENTASid`) REFERENCES `pacientai` (`id`),
  ADD CONSTRAINT `skiria_t` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`),
  ADD CONSTRAINT `tyrimai_ibfk_1` FOREIGN KEY (`tipas`) REFERENCES `tyrimo_tipas` (`id`);

--
-- Constraints for table `tyrimu_rezultatai`
--
ALTER TABLE `tyrimu_rezultatai`
  ADD CONSTRAINT `apima` FOREIGN KEY (`fk_TYRIMASid_TYRIMAS`) REFERENCES `tyrimai` (`id`),
  ADD CONSTRAINT `vertina` FOREIGN KEY (`fk_RODIKLISid_RODIKLIS`) REFERENCES `rodikliai` (`id`);

--
-- Constraints for table `vartotojo_info`
--
ALTER TABLE `vartotojo_info`
  ADD CONSTRAINT `vartotojo_info_ibfk_1` FOREIGN KEY (`tipas`) REFERENCES `vartotojo_tipas` (`id`);

--
-- Constraints for table `vizitai`
--
ALTER TABLE `vizitai`
  ADD CONSTRAINT `registruoja` FOREIGN KEY (`fk_PACIENTASid`) REFERENCES `pacientai` (`id`),
  ADD CONSTRAINT `tvirtina` FOREIGN KEY (`fk_GYDYTOJASid`) REFERENCES `gydytojai` (`id`);
COMMIT;
